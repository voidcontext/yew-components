...
in {
  "cypress-12.9.0" = nodeEnv.buildNodePackage {
    name = "cypress";
    packageName = "cypress";
    version = "12.9.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/cypress/-/cypress-12.9.0.tgz";
      sha512 = "Ofe09LbHKgSqX89Iy1xen2WvpgbvNxDzsWx3mgU1mfILouELeXYGwIib3ItCwoRrRifoQwcBFmY54Vs0zw7QCg==";
    };
    dependencies = [
